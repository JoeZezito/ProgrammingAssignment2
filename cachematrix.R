...
## makeCachMatrix creates a special matrix that is really a list containing a function to 
...
makeCacheMatrix <- function(x = matrix()) {
    ...
    getmean <- function() m
    list(setmean = setmean,
         getmean = getmean)
}


## cachesolve calculates the inverse of the special "matrix" created with the makeCachMatrix 
